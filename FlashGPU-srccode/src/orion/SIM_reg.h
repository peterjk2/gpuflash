...
/* function prototypes */
extern int FUNC(SIM_reg_power_init, SIM_array_info_t *info, SIM_array_t *arr,
                SIM_reg_port_state_t *read_port,
                SIM_reg_port_state_t *write_port);
extern int FUNC(SIM_reg_power_report, SIM_array_info_t *info, SIM_array_t *arr);
extern int FUNC(SIM_reg_avg_power, SIM_array_info_t *info, SIM_array_t *arr,
                int rw);
/* wrapper functions */
extern int FUNC(SIM_reg_power_dec, SIM_array_info_t *info, SIM_array_t *arr,
                u_int port, LIB_Type_max_uint row_addr, int rw);
extern int FUNC(SIM_reg_power_data_read, SIM_array_info_t *info,
                SIM_array_t *arr, P_DATA_T data);
extern int FUNC(SIM_reg_power_data_write, SIM_array_info_t *info,
                SIM_array_t *arr, u_int port, LIB_Type_max_uint old_data,
                LIB_Type_max_uint new_data);
extern int FUNC(SIM_reg_power_output, SIM_array_info_t *info, SIM_array_t *arr,
                P_DATA_T data);
