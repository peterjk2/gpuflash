...
extern int SIM_permu_record(SIM_permu_t *permu, LIB_Type_max_uint in,
                            u_int mode, LIB_Type_max_uint op, int reset);
extern LIB_Type_max_uint SIM_permu_record_test(SIM_permu_t *permu,
