...
#define PARM_in_share_buf \
  1 /* do input virtual channels physically share buffers? */
#define PARM_out_share_buf \
  1 /* do output virtual channels physically share buffers? */
/* ?? */
#define PARM_in_share_switch \
  0 /* do input virtual channels share crossbar input ports? */
